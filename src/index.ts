...
import { Container, Graphics, GraphicsGeometry, RENDERER_TYPE, Loader, Sprite, interaction, Filter, Texture, resources } from "pixi.js"
...
import { PixelShader } from "./07_shader/PixelShader"
...
loader
    ...
    .load(async () => {
        ...
        // const pixelFilter = new PixelShader(2)
        // sprite.filters = [pixelFilter]
        ...
        const videoSource = new resources.VideoResource('v1.mp4', {
            autoPlay: false,
            autoLoad: true,
            updateFPS: 60
        });
        ...
        videoSprite.filters = [new PixelShader(12)]

        renderer.stage.addChild(videoSprite)
